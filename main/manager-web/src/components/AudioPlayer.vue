...
// Return corresponding icon path according to volume state
...
const toggleMute = () => {
  ...
  // Restore default volume if unmuting and volume is 0
  if (!isMuted.value && volume.value === 0) {
    volume.value = 0.5
...
const updateSliderPosition = () => {
  nextTick(() => {
    ...
    // Center vertically and horizontally on button
