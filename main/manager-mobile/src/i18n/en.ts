...
export default {
  ...
  'agent.playDemo': 'Play Voice Demo',
  'agent.playingDemo': 'Playing Demo...',
  'agent.audioLoadFailed': 'Failed to load audio preview',
  ...
  'device.rebootConfirmMsg': 'Are you sure you want to reboot device {macAddress}?',
  'device.rebootSuccess': 'Reboot command sent',
  'device.rebootFailed': 'Failed to send reboot command',
  'device.volumeSetSuccess': 'Volume updated',
  'device.volumeSetFailed': 'Failed to update volume',
  'device.signal': 'Signal',
  'device.signalStrong': 'Strong',
  'device.signalGood': 'Good',
  'device.signalFair': 'Fair',
  'device.signalWeak': 'Weak',
  ...
  'voiceprint.securitySettings': 'Voiceprint Security Policy',
  'voiceprint.securityDesc': 'Protect smart home devices and sensitive system commands with speaker verification.',
  'voiceprint.requireSmartHome': 'Require Voice Match for Smart Home',
  'voiceprint.requireSmartHomeDesc': 'Only authorized registered voices can trigger smart home switches and appliances',
  'voiceprint.confidenceThreshold': 'Confidence Threshold',
  'voiceprint.adminSpeakerOnly': 'Admin Speaker Only for Sensitive Actions',
  'voiceprint.adminSpeakerOnlyDesc': 'Restrict device reboot, door unlocking, and system commands to Admin voices',
  'voiceprint.saveSecurity': 'Save Policy',
  'voiceprint.securitySaved': 'Voiceprint security settings updated',
  'voiceprint.securitySaveFailed': 'Failed to save security settings',
  ...
  // About us
  'settings.aboutApp': 'About ESP Console',
  'settings.aboutContent': 'ESP Console\n\nA modern smart hardware management app for ESP devices, AI agents, and voice services.\n\nWebsite: https://esp.czbd.app\n© 2026 ESP {version}',
  ...
  'agent.tools.smartHomeGuide': 'Smart Home Voice Control (Bengali & English)',
  'agent.tools.smartHomeGuideDesc': 'Control devices naturally by speaking in Bengali or English. Click below to insert sample devices.',
  'agent.tools.addLight': 'Light',
  'agent.tools.addFan': 'Fan',
  'agent.tools.addClimate': 'AC / Climate',
  'agent.tools.addSwitch': 'Switch',
  'agent.tools.addLock': 'Door Lock',
  'agent.tools.sampleCommands': 'Sample Voice Queries',


  // Device Config page
  'deviceConfig.pageTitle': 'Device Configuration',
  'deviceConfig.wifiConfig': 'WiFi Configuration',
  'deviceConfig.bleConfig': 'Bluetooth (BLE) Fast Config',
  'deviceConfig.bleScanDevices': 'Scan for Bluetooth Devices',
  'deviceConfig.bleScanning': 'Scanning for nearby BLE devices...',
  'deviceConfig.bleStopScan': 'Stop Scanning',
  'deviceConfig.bleNoDevices': 'No ESP32 Bluetooth devices found. Ensure device is powered on and in pairing mode.',
  'deviceConfig.bleConnecting': 'Connecting to Bluetooth device...',
  'deviceConfig.bleConnected': 'Connected to ESP32 via Bluetooth',
  'deviceConfig.bleSending': 'Sending WiFi credentials over BLE...',
  'deviceConfig.bleSuccess': 'WiFi credentials sent successfully via Bluetooth!',
  'deviceConfig.bleFailed': 'Bluetooth provisioning failed. Please retry.',
  'deviceConfig.bleNotAvailable': 'Bluetooth is not available or disabled on this device. Please turn on Bluetooth.',
  'deviceConfig.bleGuide': 'Connect to ESP32 without leaving mobile data. Make sure Bluetooth is on and device is near.',
  ...
  'deviceConfig.hiddenWifi': 'Hidden WiFi',
  'deviceConfig.hiddenWifiPrompt': 'Connect to hidden network',
  'deviceConfig.hiddenWifiSsid': 'Network Name (SSID)',
  'deviceConfig.enterHiddenWifiSsid': 'Enter hidden WiFi name (SSID)',
  'deviceConfig.requiresPassword': 'Requires Password',
  'deviceConfig.addHiddenNetwork': 'Connect to Hidden Network',
  'deviceConfig.startConfig': 'Start Configuration',
  'deviceConfig.connectToXiaozhiHotspot': 'Please connect to ESP hotspot first (ESP-XXXXXX)',
  'deviceConfig.detecting': 'Detecting...',
  'deviceConfig.reDetect': 'Re-detect',
  'deviceConfig.alreadyConnected': 'Connected to ESP hotspot',
  ...
  'deviceConfig.bringPhoneCloseToXiaozhiDevice': 'Bring phone close to ESP device (1-2 meters distance)',
  'deviceConfig.duringAudioPlaybackXiaozhiWillReceive': 'During audio playback, ESP device will receive and decode configuration information',
  ...
  'deviceConfig.connectXiaozhiHotspot': 'Please connect to ESP hotspot (ESP-XXXXXX)',
  ...
  'deviceConfig.connectedXiaozhiHotspot': 'Connected to ESP hotspot',
  ...
  'deviceConfig.pleaseDisconnectXiaozhiHotspot': 'Please disconnect from ESP hotspot',
  ...
  'deviceConfig.phoneConnectXiaozhiHotspot': 'Connect phone to ESP hotspot (ESP-XXXXXX)',
