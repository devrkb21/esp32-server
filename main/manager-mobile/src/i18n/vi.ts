...
export default {
  ...
  'agent.playDemo': 'Phát thử giọng nói',
  'agent.playingDemo': 'Đang phát thử...',
  'agent.audioLoadFailed': 'Không thể tải bản xem trước âm thanh',
  ...
  'device.volume': 'Âm lượng',
  'device.reboot': 'Khởi động lại',
  'device.rebootConfirmTitle': 'Khởi động lại thiết bị',
  'device.rebootConfirmMsg': 'Bạn có chắc chắn muốn khởi động lại thiết bị "{macAddress}"?',
  'device.rebootSuccess': 'Đã gửi lệnh khởi động lại',
  'device.rebootFailed': 'Gửi lệnh khởi động lại thất bại',
  'device.volumeSetSuccess': 'Đã cập nhật âm lượng',
  'device.volumeSetFailed': 'Cập nhật âm lượng thất bại',
  'device.signal': 'Tín hiệu',
  'device.signalStrong': 'Mạnh',
  'device.signalGood': 'Tốt',
  'device.signalFair': 'Trung bình',
  'device.signalWeak': 'Yếu',
  ...
  'voiceprint.securitySettings': 'Chính sách bảo mật dấu giọng nói',
  'voiceprint.securityDesc': 'Bảo vệ thiết bị nhà thông minh và lệnh hệ thống nhạy cảm bằng xác minh giọng nói.',
  'voiceprint.requireSmartHome': 'Yêu cầu khớp giọng nói cho Nhà thông minh',
  'voiceprint.requireSmartHomeDesc': 'Chỉ giọng nói đã đăng ký hợp lệ mới có thể điều khiển thiết bị thông minh',
  'voiceprint.confidenceThreshold': 'Ngưỡng tin cậy',
  'voiceprint.adminSpeakerOnly': 'Chỉ người nói quản trị viên cho hành động nhạy cảm',
  'voiceprint.adminSpeakerOnlyDesc': 'Hạn chế khởi động lại thiết bị, mở khóa cửa và lệnh hệ thống cho quản trị viên',
  'voiceprint.saveSecurity': 'Lưu chính sách',
  'voiceprint.securitySaved': 'Đã cập nhật cài đặt bảo mật dấu giọng nói',
  'voiceprint.securitySaveFailed': 'Không thể lưu cài đặt bảo mật',
  ...
  // Về chúng tôi
  'settings.aboutApp': 'Về Bảng điều khiển ESP',
  'settings.aboutContent': 'Bảng điều khiển ESP\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình đại lý và các chức năng khác cho phần cứng thông minh ESP32.\n\nTrang web: https://esp.czbd.app\n© 2026 ESP {version}',
  ...
  'settings.themeAuto': 'Theo hệ thống',
  'settings.themeChanged': 'Đã thay đổi giao diện thành công',
  ...
  'agent.tools.smartHomeGuide': 'Điều khiển nhà thông minh (Bengali & Tiếng Anh)',
  'agent.tools.smartHomeGuideDesc': 'Điều khiển thiết bị thông minh bằng giọng nói tiếng Bengali hoặc tiếng Anh. Nhấp bên dưới để chèn thiết bị mẫu.',
  'agent.tools.addLight': 'Đèn',
  'agent.tools.addFan': 'Quạt',
  'agent.tools.addClimate': 'Điều hòa',
  'agent.tools.addSwitch': 'Công tắc',
  'agent.tools.addLock': 'Khóa cửa',
  'agent.tools.sampleCommands': 'Lệnh thoại mẫu',


  // Trang cấu hình thiết bị
  'deviceConfig.pageTitle': 'Cấu hình thiết bị',
  'deviceConfig.wifiConfig': 'Cấu hình WiFi',
  'deviceConfig.bleConfig': 'Cấu hình nhanh Bluetooth (BLE)',
  'deviceConfig.bleScanDevices': 'Tìm kiếm thiết bị Bluetooth',
  'deviceConfig.bleScanning': 'Đang tìm kiếm thiết bị BLE gần đây...',
  'deviceConfig.bleStopScan': 'Dừng quét',
  'deviceConfig.bleNoDevices': 'Không tìm thấy thiết bị ESP32 Bluetooth. Hãy đảm bảo thiết bị đang bật nguồn.',
  'deviceConfig.bleConnecting': 'Đang kết nối tới thiết bị Bluetooth...',
  'deviceConfig.bleConnected': 'Đã kết nối tới ESP32 qua Bluetooth',
  'deviceConfig.bleSending': 'Đang gửi thông tin WiFi qua BLE...',
  'deviceConfig.bleSuccess': 'Đã gửi thông tin cấu hình WiFi thành công qua Bluetooth!',
  'deviceConfig.bleFailed': 'Cấu hình Bluetooth thất bại. Vui lòng thử lại.',
  'deviceConfig.bleNotAvailable': 'Bluetooth không khả dụng hoặc bị tắt. Vui lòng bật Bluetooth.',
  'deviceConfig.bleGuide': 'Kết nối tới ESP32 mà không cần ngắt mạng di động. Hãy bật Bluetooth và để thiết bị ở gần.',
  'deviceConfig.ultrasonicConfig': 'Cấu hình sóng siêu âm',
  ...
  'deviceConfig.hiddenWifi': 'WiFi ẩn',
  'deviceConfig.hiddenWifiPrompt': 'Kết nối mạng ẩn',
  'deviceConfig.hiddenWifiSsid': 'Tên mạng (SSID)',
  'deviceConfig.enterHiddenWifiSsid': 'Nhập tên WiFi ẩn (SSID)',
  'deviceConfig.requiresPassword': 'Yêu cầu mật khẩu',
  'deviceConfig.addHiddenNetwork': 'Kết nối mạng ẩn',
  'deviceConfig.startConfig': 'Bắt đầu cấu hình',
  'deviceConfig.connectToXiaozhiHotspot': 'Vui lòng kết nối với điểm phát sóng ESP trước (ESP-XXXXXX)',
  'deviceConfig.detecting': 'Đang phát hiện...',
  'deviceConfig.reDetect': 'Phát hiện lại',
  'deviceConfig.alreadyConnected': 'Đã kết nối với điểm phát sóng ESP',
  ...
  'deviceConfig.bringPhoneCloseToXiaozhiDevice': 'Đưa điện thoại lại gần thiết bị ESP (khoảng cách 1-2 mét)',
  'deviceConfig.duringAudioPlaybackXiaozhiWillReceive': 'Trong khi phát âm thanh, ESP sẽ nhận và giải mã thông tin cấu hình',
  ...
  'deviceConfig.connectXiaozhiHotspot': 'Vui lòng kết nối với điểm phát sóng ESP (ESP-XXXXXX)',
  ...
  'deviceConfig.connectedXiaozhiHotspot': 'Đã kết nối với điểm phát sóng ESP',
  ...
  'deviceConfig.pleaseDisconnectXiaozhiHotspot': 'Vui lòng ngắt kết nối khỏi điểm phát sóng ESP',
  ...
  'deviceConfig.phoneConnectXiaozhiHotspot': 'Điện thoại kết nối với điểm phát sóng ESP (ESP-XXXXXX)',
