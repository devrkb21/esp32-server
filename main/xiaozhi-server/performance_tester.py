...
print("Before use, please prepare configuration according to doc/performance_testerer.md.")
...
def main():
    ...
    if not modules:
        print("No performance testing tools available in performance_tester directory.")
        return
    ...
    try:
        choice = int(input("Please select the number of the performance testing tool to invoke: ")) - 1
