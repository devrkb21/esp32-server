...
class TTSProvider(TTSProviderBase):
    def __init__(self, config, delete_audio_file):
        ...
        default_pronunciation_dict = {"tone": ["handle/(chu3)(li3)", "danger/dangerous"]}
    ...
    async def open_audio_channels(self, conn):
        ...
        # Update sample_rate in audio_setting to actual conn.sample_rate
    ...
    async def text_to_speak(self, text, is_last):
        """Streaming TTS audio processing, push audio list once per sentence"""
        payload = {
            "model": self.model,
            "text": text,
            "stream": True,
                ...
                async with session.post(
                    ...
                    async for chunk in resp.content.iter_any():
                        ...
                        while True:
                            ...
                            # Extract single complete JSON chunk
                            ...
                            try:
                                ...
                                # Only process valid audio chunks with status=1, ignore ending summary chunks with status=2
                    ...
                    # If last segment, output audio completed
                    if is_last:
                        self._process_before_stop_play_files()
    ...
    def to_tts(self, text: str) -> list:
        ...
        Returns:
            list: Return list of opus encoded audio data
        """
        ...
        try:
            with requests.post(
                ...
                logger.info(f"TTS request successful: {text}, elapsed: {time.time() - start_time}s")
