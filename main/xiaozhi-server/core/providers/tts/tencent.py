...
class TTSProvider(TTSProviderBase):
    ...
    def _get_auth_headers(self, request_body):
        ...
        # Request headers must contain host and content-type, sorted lexicographically
        canonical_headers = (
    ...
    async def text_to_speak(self, text, output_file):
        ...
        try:
            # Get request headers (regenerate each request to ensure timestamp and signature are fresh)
