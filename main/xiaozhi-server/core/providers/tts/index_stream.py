...
class TTSProvider(TTSProviderBase):
    def __init__(self, config, delete_audio_file):
        ...
        # Create Opus encoder, note that interface returned sample rate is 24000
    ...
    def audio_to_pcm_data_stream(
        ...
        """Convert audio file to PCM encoding, using 24kHz sample rate"""
    ...
    def audio_to_opus_data_stream(
        ...
        """Convert audio file to Opus encoding, using 24kHz sample rate and own encoder"""
        from core.utils.util import audio_to_data_stream
            ...
            with requests.post(
                ...
                for i in range(0, len(pcm_data), frame_bytes):
                    ...
                    if len(frame) < frame_bytes:
                        # Last frame may be incomplete, pad with 0
