"""IoT device support module, providing IoT device descriptor and status handling"""
...
async def handleIotDescriptors(conn: "ConnectionHandler", descriptors):
    ...
    for descriptor in descriptors:
        # If descriptor lacks properties and methods, skip directly
    ...
    # If new functions registered, update function descriptions list
