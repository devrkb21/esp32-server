...
class VADProvider(VADProviderBase):
    ...
    def _init_connection_state(self, conn):
        """Initialize separate VAD state for the connection"""
    ...
    def release_conn_resources(self, conn):
        """Release VAD resources of the connection (called when connection closes)"""
    ...
    def is_vad(self, conn, pcm_frame):
        # Manual mode: return True directly without real-time VAD detection, buffer all audio
        ...
        try:
            ...
            while len(conn.client_audio_buffer) >= 512 * 2:
                ...
                # If voice is not below minimum, maintain previous state
                ...
                # If there was voice previously, but not now, and silence exceeds threshold, consider sentence finished
