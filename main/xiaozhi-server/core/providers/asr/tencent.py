...
class ASRProvider(ASRProviderBase):
    ...
    async def speech_to_text(
        ...
        try:
            ...
            if not self.secret_id or not self.secret_key:
                logger.bind(tag=TAG).error("Tencent Cloud speech recognition configuration not set, unable to recognize")
                return None, None
    ...
    def _build_request_body(self, base64_audio: str) -> str:
        ...
        request_map = {
            ...
            "EngSerViceType": "16k_zh",  # Mandarin Chinese common
            "SourceType": 1,  # Audio source is speech file
    ...
    def _get_auth_headers(self, request_body: str) -> Tuple[str, str]:
        ...
        try:
            ...
            # Use TC3-HMAC-SHA256 signature algorithm
            ...
            # Note: Header info must be sorted in ASCII ascending order, and keys/values converted to lowercase
            ...
            logger.bind(tag=TAG).error(f"Failed to generate authorization headers: {e}", exc_info=True)
            raise RuntimeError(f"Failed to generate authorization headers: {e}")
    ...
    def _sha256_hex(self, data: str) -> str:
        """Calculate SHA256 hex digest of string"""
