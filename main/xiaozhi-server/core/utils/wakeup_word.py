        ...
        while True:
            try:
                ...
                if time.time() - self.start_time > self.timeout:
                    raise TimeoutError("Acquiring file lock timed out")
                time.sleep(0.1)
...
class WakeupWordsConfig:
    ...
    def update_wakeup_response(self, voice: str, file_path: str, text: str):
        ...
        try:
            ...
            print(f"Failed to update wakeup response config: {e}")
            raise
