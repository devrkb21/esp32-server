...
def decode_opus_from_file(input_file):
    """
    Decode Opus data from p3 file and return list of Opus packets and total duration.
    """
    opus_datas = []
    total_frames = 0
    ...
    with open(input_file, 'rb') as f:
        while True:
            ...
            # Read Opus data based on length specified in header
...
def decode_opus_from_bytes(input_bytes):
    """
    Decode Opus data from p3 binary data and return list of Opus packets and total duration.
    """
    import io
    opus_datas = []
    total_frames = 0
