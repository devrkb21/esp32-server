...
description = "Non-streaming TTS performance testing"
...
class TTSPerformanceTester:
    def __init__(self, config):
        ...
        self.test_sentences = self.config.get("module_test", {}).get(
            ...
            [
                ...
                "Men relate to each other through life, sharing intimate thoughts or pursuing desires without restraint.",
                "Whenever I look upon the reasons that moved ancients, I am deeply stirred in my heart.",
            ],
        )
        self.results = {}
    ...
    async def _test_tts(self, tts_name: str, config: Dict) -> Dict:
        ...
        try:
            ...
            # Set mock conn object to prevent TTS from accessing None self.conn.sample_rate
            class MockConn:
                sample_rate = 16000
                audio_format = "pcm"
            ...
            # Set mock opus_encoder to prevent TTS from accessing None self.opus_encoder
    ...
    def _print_results(self):
        ...
        headers = ["TTS Module", "Avg Elapsed(s)", "Sentences Tested", "Status"]
        table_data = []
        ...
        # Sort by average elapsed time ascending
        ...
        print("- Error handling: Unreachable and timed-out models categorized as network errors")
        print("- Sort rule: Sorted by average duration ascending")

    async def run(self):
        """Execute test"""
        print("Starting TTS performance testing...")
...
# For performance_tester.py invocation
async def main():
