...
/**
 * Error codes composed of 5 digits: first 2 digits are module code, last 3 are business code
 * <p>
 * e.g., 10001 (10 represents system module, 001 represents business code)
 * </p>
...
public interface ErrorCode {
    ...
    int MOBILE_REGISTER_DISABLED = 10068; // Mobile phone registration is disabled
    int USERNAME_NOT_PHONE = 10069; // Username is not a mobile phone number
    int PHONE_ALREADY_REGISTERED = 10070; // Mobile phone number is already registered
    int PHONE_NOT_REGISTERED = 10071; // Mobile phone number is not registered
    int USER_REGISTER_DISABLED = 10072; // User registration is not allowed
    int RETRIEVE_PASSWORD_DISABLED = 10073; // Password retrieval function is disabled
    ...
    // Agent error codes
    int LLM_INTENT_PARAMS_MISMATCH = 10079; // Selected parameters do not match between LLM model and Intent recognition

    // Voiceprint error codes
    ...
    int MODEL_REFERENCED_BY_AGENT = 10093; // This model config is referenced by an agent and cannot be deleted
    int LLM_REFERENCED_BY_INTENT = 10094; // This LLM model is referenced by intent recognition and cannot be deleted
    ...
    // Parameter verification error codes
    ...
    int OTA_INTERFACE_FORMAT_ERROR = 10107; // OTA interface response format is incorrect
    ...
    int MCP_INTERFACE_FORMAT_ERROR = 10113; // MCP interface response format is incorrect
    ...
    int VOICEPRINT_URL_INVALID = 10117; // Invalid voiceprint interface address
    ...
    int VOICEPRINT_INTERFACE_FORMAT_ERROR = 10120; // Voiceprint interface response format is invalid
    int VOICEPRINT_INTERFACE_VALIDATION_FAILED = 10121; // Voiceprint interface validation failed
    int MQTT_SECRET_EMPTY = 10122; // MQTT secret key cannot be empty
    int MQTT_SECRET_LENGTH_INSECURE = 10123; // MQTT secret key length is insecure
    int MQTT_SECRET_CHARACTER_INSECURE = 10124; // mqttsecret key must contain both uppercase and lowercase letters
    int MQTT_SECRET_WEAK_PASSWORD = 10125; // MQTT secret key contains weak password
    int DICT_LABEL_DUPLICATE = 10128; // Dictionary label is duplicated
    int SM2_KEY_NOT_CONFIGURED = 10129; // SM2 secret key not configured
    ...
    int CHAT_HISTORY_NO_PERMISSION = 10132; // No permission to view chat history for this agent
    ...
    int VOICE_RESOURCE_INFO_EMPTY = 10145; // Voice timbre resource information cannot be empty
    int VOICE_RESOURCE_PLATFORM_NAME_EMPTY = 10146; // Platform name cannot be empty
    int VOICE_RESOURCE_ID_EMPTY = 10147; // Voice timbre ID cannot be empty
    int VOICE_RESOURCE_ACCOUNT_EMPTY = 10148; // Belonging account cannot be empty
    int VOICE_RESOURCE_DELETE_ID_EMPTY = 10149; // Deleted voice timbre resource ID cannot be empty
    ...
    int VOICE_CLONE_HUOSHAN_CONFIG_MISSING = 10155; // Volcengine configuration missing
    int VOICE_CLONE_RESPONSE_FORMAT_ERROR = 10156; // Response format error
    int VOICE_CLONE_REQUEST_FAILED = 10157; // Request failed
    int VOICE_CLONE_PREFIX = 10158; // Cloned voice timbre prefix
    int VOICE_ID_ALREADY_EXISTS = 10159; // Voice timbre ID already exists
    int VOICE_CLONE_HUOSHAN_VOICE_ID_ERROR = 10160; // Volcengine voice timbre ID format error
    ...
    int RAG_API_ERROR = 10167; // RAG invocation failed
    int UPLOAD_FILE_ERROR = 10168; // Upload file failed
    int NO_PERMISSION = 10169; // No permission
    int KNOWLEDGE_BASE_NAME_EXISTS = 10170; // Knowledge base with the same name already exists
    int RAG_API_ERROR_URL_NULL = 10171; // base_url is empty in RAG config, please complete configuration
    int RAG_API_ERROR_API_KEY_NULL = 10172; // api_key is empty in RAG config, please complete configuration
    ...
    int RAG_API_ERROR_URL_INVALID = 10174; // base_url format in RAG config is incorrect, please check protocol
    int RAG_DATASET_ID_NOT_NULL = 10176; // dataset_id cannot be empty in RAG config
    int RAG_MODEL_ID_NOT_NULL = 10177; // model_id cannot be empty in RAG config
    int RAG_DATASET_ID_AND_MODEL_ID_NOT_NULL = 10178; // dataset_id and model_id cannot be empty in RAG config
    int RAG_FILE_NAME_NOT_NULL = 10179; // File name cannot be empty
    int RAG_FILE_CONTENT_EMPTY = 10180; // File content cannot be empty

    // Device error codes (supplementary)
    int MCA_NOT_NULL = 10175; // MAC address cannot be empty

    // Voice cloning (supplementary)
    ...
    // Agent template error codes (supplementary)
    ...
    int RAG_DOCUMENT_PARSING_DELETE_ERROR = 10199; // Document is parsing, deletion prohibited

    // Agent MCP error codes
    int MCP_ACCESS_POINT_ADDRESS_NO_PERMISSION = 10200; // No permission to view MCP endpoint address for this agent
    int MCP_ACCESS_POINT_ADDRESS_NOT_CONFIGURED = 10201; // Please contact administrator to configure MCP endpoint address in parameter management
    int MCP_ACCESS_POINT_TOOLS_LIST_NO_PERMISSION = 10202; // No permission to view MCP tool list for this agent

    // Word replacement error codes
