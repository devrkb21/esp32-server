...
public class RedisUtils {
    ...
    /**
     * Default expiration duration is 24 hours, unit: seconds
     */
    ...
    public void emptyAll() {
        // Lua script FLUSHALL is the Redis command to flush all databases
        ...
        // Execute Lua script
        List<String> keys = Collections.emptyList(); // If script does not depend on key, pass empty list
        redisTemplate.execute(redisScript, keys);

    }

    /**
     * Get value of specified key in Redis; if empty, set default value
     * @param key Redis key
