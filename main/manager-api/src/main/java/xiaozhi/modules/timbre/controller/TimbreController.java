...
@Tag(name = "Voice timbre management")
public class TimbreController {
    private final TimbreService timbreService;

    @GetMapping
    @Operation(summary = "PaginationFind")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameters({
            @Parameter(name = "ttsModelId", description = "forshould TTS ModelPrimary key", required = true),
            @Parameter(name = "name", description = "Voice timbre name"),
    ...
    @PostMapping
    @Operation(summary = "Voice timbreSave")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Voice timbreUpdate")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping("/delete")
    @Operation(summary = "Voice timbreDelete")
    @RequiresPermissions("sys:role:superAdmin")
