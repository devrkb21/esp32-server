...
public class SysParamsController {
    ...
    @Parameters({
            @Parameter(name = Constant.PAGE, description = "Current page number，from1Start", in = ParameterIn.QUERY, required = true, ref = "int"),
            @Parameter(name = Constant.LIMIT, description = "Records per page", in = ParameterIn.QUERY, required = true, ref = "int"),
            @Parameter(name = Constant.ORDER_FIELD, description = "Sort field", in = ParameterIn.QUERY, ref = "String"),
            @Parameter(name = Constant.ORDER, description = "Sort direction，Optional values(asc、desc)", in = ParameterIn.QUERY, ref = "String"),
            @Parameter(name = "paramCode", description = "Parameter code or parameterRemark", in = ParameterIn.QUERY, ref = "String")
    })
    ...
    public Result<Void> update(@RequestBody SysParamsDTO dto) {
        ...
        // Verify voiceprint address
        validateVoicePrint(dto.getParamCode(), dto.getParamValue());

        // ValidateMQTT secret keyLength
        validateMqttSecretLength(dto.getParamCode(), dto.getParamValue());

        // If it isSystem function menu configuration，Use special handling
     ...
     * VerifyWebSocketAddressList
     *
     * @param urls WebSocketAddressList，Separated by semicolons
    ...
    private void validateOtaUrl(String paramCode, String url) {
        ...
        try {
            ...
            // CheckResponsewhether content containsOTARelatedInformation
    ...
    private void validateMcpUrl(String paramCode, String url) {
        ...
        try {
            ...
            // CheckResponsewhether content containsmcpRelatedInformation
            String body = response.getBody();
    ...
    // Verify whether voiceprint interface address isNormal
    ...
    // ValidateMQTT secret keyLength and complexity
    private void validateMqttSecretLength(String paramCode, String secret) {
        ...
        // Not allowed to contain weakPassword
