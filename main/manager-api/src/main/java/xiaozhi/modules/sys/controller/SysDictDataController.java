...
public class SysDictDataController {
    ...
    @GetMapping("/page")
    @Operation(summary = "Paginate query dictionary data")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameters({ @Parameter(name = "dictTypeId", description = "Dictionary typeID", required = true),
    ...
    public Result<PageData<SysDictDataVO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params) {
        ...
        // Enforce validationdictTypeIdWhether exists
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get dictionary dataDetails")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "Get dictionary dataList")
