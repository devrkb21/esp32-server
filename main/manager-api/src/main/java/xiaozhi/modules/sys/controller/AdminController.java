...
public class AdminController {
    ...
    @GetMapping("/users")
    @Operation(summary = "PaginationFind user")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameters({
            @Parameter(name = "mobile", description = "UserPhone numberCode", required = false),
    ...
    @Operation(summary = "BatchUpdateUserStatus")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "PaginationFind device")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameters({
