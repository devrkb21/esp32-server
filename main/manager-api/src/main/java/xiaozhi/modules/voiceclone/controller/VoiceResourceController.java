...
public class VoiceResourceController {
    ...
    @GetMapping("{id}")
    @Operation(summary = "Get voice timbre resource details")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping
    @Operation(summary = "NewaddVoice timbre resource")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "DeleteVoice timbre resource")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @Operation(summary = "According toUser IDGet voice timbre resource list")
