...
public class VoiceCloneServiceImpl extends BaseServiceImpl<VoiceCloneDao, VoiceCloneEntity>
    ...
    public void save(VoiceCloneDTO dto) {
        ...
        // CheckVoice IDWhetherAlready beenUse
        ...
        // Traverse selectionVoice timbreID，asEachVoice timbreIDCreate a record
        int index = 0;
    ...
    public VoiceCloneResponseDTO getByIdWithNames(String id) {
        ...
        // EnsuretrainStatusField is correctlySet，Frontend requires this field to determine if it is cloned audio
    ...
    /**
     * VoiceCloneEntityListConvertasVoiceCloneResponseDTOList
     */
    ...
    /**
     * Call Volcengine for voice replication training
     * 
    ...
    private void huoshanClone(Map<String, Object> config, VoiceCloneEntity entity) throws Exception {
        ...
        if (baseResp != null) {
            ...
            if (statusCode != null && statusCode == 0 && StringUtils.isNotBlank(speakerId)) {
                ...
                // FailwhenUseStatusMessagedoasErrorInformation
