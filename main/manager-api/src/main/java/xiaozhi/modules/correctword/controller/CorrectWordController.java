...
@Tag(name = "Replacement word management")
@AllArgsConstructor
public class CorrectWordController {
    ...
    @PostMapping("/file")
    @Operation(summary = "CreateReplacement word file")
    ...
    @Operation(summary = "UpdateReplacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Paginate get current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    @Parameters({
    ...
    @Operation(summary = "Agent obtains current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "DownloadReplacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "DeleteReplacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Batch delete replacement word files")
    @RequiresPermissions("sys:role:normal")
