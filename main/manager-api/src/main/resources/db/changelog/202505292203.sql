-- ===============================
-- 1. Insert plugin record into ai_model_provider
-- ===============================
START TRANSACTION;


-- Do not set function list for intent_llm and function_call
...
'key', 'api_key',
'type', 'string',
'label', 'Weather Plugin API Secret Key',
...
'Plugin',
'hass_set_state',
'HomeAssistant Device State Modify',
JSON_ARRAY(),
60, 0, NOW(), 0, NOW());
...
) COMMENT 'Unique mapping table between Agent and plugins';
