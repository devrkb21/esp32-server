...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (310, 'wakeup_words', 'HelloXiaozhi;Hello Xiaozhi;Xiaoai Student;Hello Xiaoxin;Hello Xiaoxin;Xiaomei Student;Xiaolong Xiaolong;Meow Student;Xiaobin Xiaobin;Xiaobing Xiaobing', 'array', 1, 'Wake-word list for keyword spotting');
...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (410, 'plugins.get_news.default_rss_url', 'https://www.chinanews.com.cn/rss/society.xml', 'string', 1, 'News plugin defaultRSSAddress');
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (411, 'plugins.get_news.category_urls', '{"society":"https://www.chinanews.com.cn/rss/society.xml","world":"https://www.chinanews.com.cn/rss/world.xml","finance":"https://www.chinanews.com.cn/rss/finance.xml"}', 'json', 1, 'News plugin categoryRSSAddress');
