...
UPDATE ai_model_config set model_name = 'Volcengine(Streaming)' where id = 'TTS_HuoshanDoubleStreamTTS';
...
UPDATE ai_model_config SET config_json='{\"type\": \"openai\", \"base_url\": \"https://ark.cn-beijing.volces.com/api/v3\", \"model_name\": \"doubao-1-5-pro-32k-250115\", \"api_key\": \"Yourapi_key\"}' where id = 'LLM_DoubaoLLM' AND config_json LIKE '%Yourapi_key"%';