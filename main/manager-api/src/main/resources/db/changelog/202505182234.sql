-- Add required parameters for SMS registration feature
...
(109, 'server.beian_icp_num', 'null', 'string', 1, 'ICP filing number, set to null if not configured', NULL, NULL, NULL, NULL),
(110, 'server.beian_ga_num', 'null', 'string', 1, 'Public security filing number, set to null if not configured', NULL, NULL, NULL, NULL),
(111, 'server.enable_mobile_register', 'false', 'boolean', 1, 'Whether to enable mobile phone registration', NULL, NULL, NULL, NULL),
(112, 'server.sms_max_send_count', '10', 'number', 1, 'Max daily SMS messages per phone number', NULL, NULL, NULL, NULL),
(610, 'aliyun.sms.access_key_id', '', 'string', 1, 'your_aliyun_access_key', NULL, NULL, NULL, NULL),
(611, 'aliyun.sms.access_key_secret', '', 'string', 1, 'your_aliyun_access_key_secret', NULL, NULL, NULL, NULL),
...
update sys_params set remark = 'Whether to allow registration for non-admin users' where param_code = 'server.allow_user_register';
...
(102, 'MOBILE_AREA', 'Mobile Area', 'Mobile AreaDictionary', 0, 1, NOW(), 1, NOW());
...
(102006, 102, 'UK', '+44', 'UK', 6, 1, NOW(), 1, NOW()),
