...
export function checkOpusLoaded() {
    try {
        ...
        // Try using Module.instance first (export method in last line of libopus.js)
        ...
        log(`Opus library failed to load, please check if libopus.js exists and is correct: ${err.message}`, 'error');
    }
}
        ...
        opusEncoder = {
            ...
            init: function () {
                try {
                    ...
                    // Set complexity (0-10, higher is better quality but more CPU usage)
                    mod._opus_encoder_ctl(this.encoderPtr, 4010, 5);     // OPUS_SET_COMPLEXITY

                    // Set DTX (do not transmit silence frames)
